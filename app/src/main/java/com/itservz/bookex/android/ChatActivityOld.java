...
public class ChatActivityOld extends AppCompatActivity implements View.OnClickListener,
    ...
    private class MessagesAdapter extends ArrayAdapter<ChatMessage> {
        MessagesAdapter(ArrayList<ChatMessage> messages) {
            super(ChatActivityOld.this, R.layout.chat_message, R.id.message, messages);
        }
